...
public class HUD : MonoBehaviour {
	...
	public Equipment e2;
	public Equipment e3;
	private GameObject _NewGUIMenu;
	...
	void Start()
	{
		...
		//_NewGUIMenu = (GameObject)Resources.Load ("ProjectAssets/GUI/MenuCanvas", typeof(GameObject));
	}
	...
	void OnGUI(){
		//Commented out for new GUI implementation
